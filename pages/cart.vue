<template>
    <div class="pt-3 sm:pt-5 lg:pt-7 pb-7 sm:pb-9 lg:pb-12 flex items-center justify-between">
    ...
    <ClientOnly>
        <div v-if="cart.length >= 1">
            <div class="bg-white rounded-2xl">
                <div class="mx-auto max-w-2xl px-3 py-5 lg:max-w-7xl">
                    <form class="mt-12 lg:grid lg:grid-cols-12 lg:items-start lg:gap-x-12 xl:gap-x-16">
                        ...
                        <!-- Order summary -->
                        <section aria-labelledby="summary-heading" class="mt-16 rounded-lg bg-gray-50 px-4 py-6 sm:p-6 lg:col-span-5 lg:mt-0 lg:p-8 lg:sticky lg:top-24">
