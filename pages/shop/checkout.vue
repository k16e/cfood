                        ...
                        <section
                            ...
                            <form
                                ...
                                <button
                                    ...
                                    :class="{ 'cursor-not-allowed': formActions.sending.value }"
                                    :disabled="formActions.sending.value">
                                    <svg v-if="formActions.sending.value" class="mr-3 h-5 w-5 text-white animate-spin" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
...
const { proceedToPay } = useOrderCompletion(
    formActions, order, customer, shippingRates, subTotal, store, cart, router
)
</script>